...
Enable every person to operate with the intelligence and capabilities of the entire enterprise. Source available. Five working AI use cases, live in 14 days, at zero cost. Set your rules once; everyone builds governed AI on top.
...
| --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------- |
| Model gateway                           | [OGAD (Off Grid AI Desktop)](https://github.com/off-grid-ai/OGAD) in gateway mode, OpenAI-compatible, local fleet or cloud                         | —                                                                                                                                                                                                            | Gateway              |

...
export const SEED_CONNECTORS: SeedConnectorSpec[] = [
  {
    ...
    type: 'postgres',
    endpoint: `postgres://corebank:corebank@${DS_HOST}:5433/corebank`,
  ...
  },
  {
    ...
    type: 'mysql',
    endpoint: `mysql://policyadmin:policyadmin@${DS_HOST}:3307/policyadmin`,
  ...
  },
  {
    ...
    type: 'mssql',
    endpoint: `mssql://sa:Offgrid!Erp2026@${DS_HOST}:1433/master`,

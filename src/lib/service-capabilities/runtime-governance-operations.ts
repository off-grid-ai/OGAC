  ...
  audit({
    ...
    capabilities: [
      [
        ...
        'Inspect Redis',
        'PROVEN 2026-08-04 for selection + evidence. Remaining: no console PAGE renders the counters yet — cacheEvidence is consumed by nothing on screen, so an operator still has to read them through the API.',
        [
          'yes',
          ...
          'partial',
          'Service detail exposes health. The counters exist and are correct but no page renders them yet.',
          'yes',

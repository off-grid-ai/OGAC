  ...
  audit({
    ...
    capabilities: [
      ...
      [
        ...
        '/workspace/chat',
        'Open chat',
        'The offgrid-chat poller is live and registered, but an end-to-end governed chat run on the durable path has not been re-verified in this audit — do a live chat round-trip (guardrails + egress-DLP + provenance) and retain the evidence before promoting these gates.',
        [
          'yes',
          'The chat stream route applies governance (guardrails, egress-DLP) over the entity-consumption hierarchy.',
          'partial',
          'The chat route + offgrid-chat worker exist and register, but the durable chat execution path is not separately re-proven here.',
          'yes',
          'The chat surface exposes the operator chat experience.',
          'partial',
          'No live governed chat run is retained as evidence in this audit cycle.',
        ],
      ],
    ],
  }),

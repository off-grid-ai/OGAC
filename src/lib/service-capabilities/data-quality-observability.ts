...
const OBSERVABILITY_AUDITS: readonly ServiceCapabilityAudit[] = [
  ...
  },
  {
    ...
    items: [
      ...
      capability('answer-relevancy', 'Answer relevancy', 'Score whether an answer addresses the question.', '/solutions/quality/evaluators', 'Manage evaluators', 'Retained + attributed via the same per-metric governed path as faithfulness; omitted metrics are surfaced (never masked as a golden pass).', [

...
const OBSERVABILITY_AUDITS: readonly ServiceCapabilityAudit[] = [
  ...
  },
  {
    ...
    items: [
      ...
      capability('data-quality', 'Data quality preset', 'Run Evidently\'s data-quality preset instead of drift.', '/insights/quality', 'Open drift', '', [
      ...
      capability('psi-method', 'PSI as the drift method', 'Ask for Population Stability Index and have Evidently run it.', '/insights/quality', 'Open drift', '', [
      ...
      capability('stat-tests', 'Statistical test selection', 'Choose the statistical test used to judge drift.', '/insights/quality', 'Open drift', '', [
      ...
      capability('column-overrides', 'Per-column method overrides', 'Use a different statistical test per column.', '/insights/quality', 'Open drift', 'The contract and the engine both apply per-column overrides, but the drift workflow that exists today compares a single column (the eval score), so no PRODUCT flow sends two. Closing this needs a multi-column drift source, not more adapter work.', [

    ...
    <div className="w-full space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="max-w-3xl text-sm text-muted-foreground">
            ...
            per-app on each app&apos;s Reports tab).
          </p>
        </div>
      </div>
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Rolled up from each app&apos;s owning department. Richest first; unassigned apps last.
            </p>
          </CardHeader>
          <CardContent>
      ...
      <Card className="shadow-sm">
        <CardHeader>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Every app ranked by net value. Open one for its full ROI card and to tune its estimate.
          </p>
        </CardHeader>
        <CardContent>

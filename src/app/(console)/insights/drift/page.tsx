          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                first-party PSI, or full statistical drift test suites when the collector is
                reachable.
              </p>
            </div>
          </div>
            ...
            <Card className="shadow-sm">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  ...
                  best-effort — this surface stays reachable and will populate once eval-run history
                  or the drift collector is available.
                </p>
              </CardContent>
            </Card>
          ) : (
                ...
                <CardHeader className="flex flex-row items-center justify-between space-y-0">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      ...
                      {data.lastChecked
                        ? ` · checked ${data.lastChecked.slice(0, 19).replace('T', ' ')}`
                        : ''}
                    </p>
                  </div>

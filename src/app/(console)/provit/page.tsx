        ...
        <div className="w-full space-y-6">
          ...
          <div className="rounded-xl border border-border bg-card p-8">
            <h2 className="text-base font-semibold text-foreground">
              Ship UI changes without breaking what worked
            </h2>
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
              Provit maps your app into its real modules, drives every behavior end to end, and
              judges the recording with vision — so a broken screen is caught in review, not by a
              user. It runs on your own gateway, under the same auth, budgets, and audit as the rest
              of the console.
            </p>

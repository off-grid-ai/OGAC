...
export default async function AppRunPage({
  params,
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-foreground">{app?.title ?? 'App run'}</h1>
                <p className="text-sm text-muted-foreground">
                  Live status of this run — watch each step execute, and approve or reject when a
                  step pauses for human review.
                </p>
              </div>
            </div>
          </div>

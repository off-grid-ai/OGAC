          ...
          {tools.length === 0 ? (
            <div className="rounded-md border border-dashed border-border p-8 text-center">
              <p className="text-sm text-muted-foreground">
                ...
                or{' '}
                <Link href="/build/tools" className="text-primary underline-offset-4 hover:underline">
                  register your own
                </Link>
                .
              </p>
        ...
        <CardHeader className="flex flex-row items-start justify-between space-y-0">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              ...
              <Link href="/workspace/knowledge" className="text-primary underline-offset-4 hover:underline">
                ...
                {promptList.map((p) => (
                  <TableRow key={p.id}>
                    <TableCell className="font-medium text-foreground">
                      <Link href={`/build/brain/prompts/${p.id}`} className="hover:text-primary">
                        {p.name}
                      </Link>
                    </TableCell>

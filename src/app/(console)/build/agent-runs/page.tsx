          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Durable jobs — which agent workflows are running now, at what state, and their
                outcome. Re-run a finished job, cancel a running one, review the recorded timeline,
                or schedule recurring runs. Recorded on-prem.
              </p>
            </div>
          </div>

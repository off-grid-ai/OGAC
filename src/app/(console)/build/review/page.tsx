      ...
      <header className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 max-w-2xl text-sm text-muted-foreground">
            Decisions waiting on you. Each one is a run an app has paused for a person to approve or
            reject. Open one to see what you&apos;re approving, why, and the amount at stake.
          </p>
        </div>
      </header>
      ...
      {items.length === 0 ? (
        <div className="flex flex-col items-center gap-2 rounded-lg border border-border py-16 text-center">
          ...
          <p className="max-w-sm text-xs text-muted-foreground">
            No runs are waiting on your decision right now. When an app pauses for approval, it shows
            up here.
          </p>
        </div>
      ) : (

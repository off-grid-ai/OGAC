        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                ...
                conversation uses, and the set of pipelines a project may be switched to — people
                can only pick from that set, so every message stays governed (policy, guardrails,
          ...
          <Card className="shadow-sm">
            <CardHeader className="flex flex-row items-center justify-between space-y-0">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Roles layered on the built-in RBAC/ABAC — each inherits a base role and grants
                  module access. SCIM group sync maps onto these (stub).
                </p>
              </div>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <p className="text-xs text-muted-foreground">
                Every underlying tool is reached through a capability port — swap it with one env
                var, no code change. Set <code>OFFGRID_ADAPTER_&lt;CAPABILITY&gt;</code> to an
                adapter id.
              </p>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Runtime toggles for capabilities/features (the first-party flag store; Unleash backs
                it at scale). Flip without a redeploy.
              </p>
            </CardHeader>
            <CardContent>
              {flags.length === 0 ? (

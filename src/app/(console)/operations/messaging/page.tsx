      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Send app results by email (governed: PII-masked + egress-leashed), verify your own sending
            domain, and give each app a forward-to inbound address. Your DNS stays yours.
          </p>
        </div>
      </div>
      <MessagingManager />

...
// The active tab lives in the URL (?tab=) — deep-linkable, Back-coherent.
      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            ...
            <a href="/tools?tab=catalog" className="text-primary underline-offset-4 hover:underline">
              Catalog
            </a>
            .
          </p>
  ...
  return (
    <div className="space-y-6">
      <p className="max-w-3xl text-sm text-muted-foreground">
        ...
        <a href="/tools" className="text-primary underline-offset-4 hover:underline">
          Registered
        </a>{' '}
        ...
        <CardContent className="flex items-start gap-3 py-4 text-sm">
          ...
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">
              ...
              <a href="/config" className="text-primary underline-offset-4 hover:underline">
                Configuration
              </a>
              ). Applied on restart.
            </p>

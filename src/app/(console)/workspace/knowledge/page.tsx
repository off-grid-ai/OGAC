        ...
        <CardHeader className="flex flex-row items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              ...
              <Link href="/build/brain?view=knowledge" className="text-primary underline-offset-4 hover:underline">
            ...
            <Table>
              ...
              <TableBody>
                {collections.map((c, i) => (
                  <TableRow key={c.id}>
                    <TableCell>
                      <Link href={`/workspace/knowledge/${c.id}`} className="hover:text-primary hover:underline">

...
// ─── /solutions/agents — canonical built-in capability catalogue ────────────────────────────────
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              Reusable built-in capabilities shipped with Off Grid AI. Open one to inspect its
              needs, tools, governed run path, and live run history. Your authored use cases remain
              Apps, with one lifecycle and one canonical editor.
            </p>
          </div>
        </div>

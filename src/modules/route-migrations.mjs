...
export const IA_ROUTE_MIGRATIONS = Object.freeze([
  ...
  { from: '/agents', to: '/solutions/apps', children: true },
  ...
  { from: '/regulatory', to: '/governance/regulatory', children: true },
  ...
  { from: '/build/agents', to: '/solutions/apps', children: true },
  ...
  { from: '/insights/drift', to: '/insights/quality', children: true },
  ...
  { from: '/insights/reports', to: '/governance/reports', children: true },

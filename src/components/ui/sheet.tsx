...
// Side-panel primitive built on the same Radix Dialog the codebase already uses.
// Unlike Dialog (centered modal), Sheet slides in from an edge — the mandate-compliant
// container for create/edit surfaces (page for listing, side-panel for create/update).
...
function SheetBody({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex-1 space-y-4 overflow-y-auto px-6', className)}
      {...props}
    />
  );
}

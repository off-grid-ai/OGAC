...
// Side-panel primitive built on Radix Dialog — same accessibility semantics as `dialog.tsx`
// (focus trap, Escape, overlay), but slides in from an edge instead of centering. Used for the
// console's create/edit surfaces so the underlying table stays visible alongside the form.

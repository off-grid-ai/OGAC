...
const TARGETS = [
  ['gateway/fleet', 'fleet'],
  ['gateway/fleet/dev_01', 'fleet-device'],
  ['gateway/ai', 'gateway'],
  ['governance', 'control'],
  ['data', 'data'],
  ['build/brain', 'brain'],
  ...
  ['build/agents/sop-synth', 'agent-detail'],
  ['build/agents/sop-synth/runs/run_d1', 'agent-trace'],
  ['insights/evals/ev_1', 'eval-detail'],
  ['build/brain/prompts/pr_02b767db', 'prompt-detail'],
];

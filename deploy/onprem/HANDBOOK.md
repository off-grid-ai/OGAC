...
**Console login (Keycloak):** `mac@`, `mohammed.ali@`, `diksha.sharma@`, `ali@example.com` — password `changeme`. Locked to `@example.com`. *Use a fresh/incognito window after any restart (stale session cookies).*
